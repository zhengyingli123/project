...
class GetFoodByType extends React.Component{
    ...
    getFoodByType(typeid){
        // let kw=typename;
        this.$axios.post('http://localhost:3000/food/getInfoByType',{typeid}).then((data)=>{
            console.log(data);
    ...
    render(){
        ...
        return(
            <div>
                <div style={{display:"inline-block",marginRight:"10px",marginBottom:"10px"}}>根据菜品类型搜索</div>
                <div style={{display:"inline-block",marginBottom:"10px"}}>
                    <Search
                        placeholder="请输入菜品类型id"
